      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status = "success") {
              (0, _alerts.showAlert)('success', "Successfully logout!");
              location.assign("/");
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', "Successfully register!");
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatepassword' : 'http://localhost:3000/api/v1/users/updatemydata';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully update!');
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../utils/appError.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var stripe = Stripe("pk_test_51LUMhgIwef8WHhdpKXyq2M26fO6dgmtcHxu8c8c43Q6O4bGIItIXb6Plo5qx3gweesx76CAR4gg1souNch9xDGD000IbPtd9GQ");

var AppError = require('../../utils/appError');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, startDateId) {
    var product, price, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log("hello"); //1Create tour

            _context.next = 4;
            return _axios.default.post("http://localhost:3000/api/v1/bookings/create-product/".concat(tourId));
          ...
          case 4:
            ...
            return _context.abrupt("return", new AppError("Couldn't create product!Please try again"));

          case 8:
            _context.next = 10;
            return _axios.default.post("http://localhost:3000/api/v1/bookings/create-price/".concat(tourId, "/").concat(product.data.product.id));
          ...
          case 10:
            ...
            return _context.abrupt("return", new AppError("Couldn't create price!Please try again"));

          case 13:
            console.log(price); //Creat checkout session

            _context.next = 16;
            return (0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(price.data.price.id, "/").concat(startDateId));

          case 16:
            session = _context.sent;
            console.log(session); // /Create checkout form + charge creadit card
          ...
          case 22:
            ...
            (0, _alerts.showAlert)("danger", "Something went wrong!Please try again");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","../../utils/appError":"../../utils/appError.js"}],"comment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteComment = exports.commentTour = void 0;
...
var commentTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(rating, review, tourId) {
    var reviewComment;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/tours/".concat(tourId, "/reviews"), {
              rating: rating,
              review: review
            });

          case 3:
            reviewComment = _context.sent;
            (0, _alerts.showAlert)("success", "You have successfully reviewed the tour");
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0);
            (0, _alerts.showAlert)("error", "You have to book the tour before continuing.");
  ...
  return function commentTour(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.commentTour = commentTour;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.delete("http://localhost:3000/api/v1/reviews/".concat(reviewId));

          case 3:
            reviewComment = _context2.sent;
            (0, _alerts.showAlert)("success", "Successfully!");
            location.reload(true);
            _context2.next = 12;
            break;
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("error", "Somthing went wrong, please try again");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","../../utils/appError":"../../utils/appError.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (registerForm) {
  document.querySelector(".registerForm").addEventListener("submit", function (e) {
    ...
    (0, _register.register)(email, name, password, passwordConfirm);
  });
} ///Update my data
...
if (updateForm) {
  document.querySelector(".updateForm").addEventListener("submit", function (e) {
    ...
    console.log("hello", form); // const email = document.getElementById("emailUpdate").value;
...
var selectStartDate = document.getElementById('selectDate');

if (bookBtn && selectStartDate) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = "Processing...";
    var tourID = e.target.dataset.tourid;
    var startDateId = selectStartDate.value; // console.log(e.target.dataset);
